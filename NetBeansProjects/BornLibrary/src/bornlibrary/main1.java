...
public class main1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Insert Username and Password");
    ...
    private void jButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MousePressed
        ...
        if(Username.getText().equals(admin.getUsername())&&password.equals(admin.getPassword())){
            AfterLogin main = new AfterLogin();
            main.setVisible(true);
            this.setVisible(false);
        }
        else{
            jLabel4.setText("UR Username or Password are wrong");
        }
